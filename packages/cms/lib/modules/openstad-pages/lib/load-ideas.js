...
//  req.data.siteUrl = siteUrl;
  ...
  if (globalData.siteId) {
    ...
    if (ideas && ideas.length > 0) {
      ...
      var options = {
           uri: `${apiUrl}/api/site/${globalData.siteId}/idea?sort=${sort}&includeVoteCount=1&includeUserVote=1&includeTags=1&includeArgsCount=1&includeGrants=1&includeTargetAudiences=1`,
           headers: headers,
