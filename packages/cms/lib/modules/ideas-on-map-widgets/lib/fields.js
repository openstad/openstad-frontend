...
module.exports = {
  ...
  arrangeFields: [
    ...
    },
    {
      name: 'map',
      label: 'Kaart',
      fields: ['mapVariant', 'mapTilesUrl', 'mapTilesSubdomains', 'mapTilesAttribution', 'mapAutoZoomAndCenter', 'mapLocationIcon', 'mapClustering', 'mapMaxClusterRadius', 'canSelectLocation', 'onMarkerClickAction' ]
    },
    {
      name: 'content',
      label: 'Content',
