exports.default = {
  ...
  getClassFielfd (name, label) => {
  return {
    name: name ? name : 'cssClasses',
    label: label ? label : 'Classes',
    type: 'array',
    titleField: 'property',
    schema: [
      {
        name: 'property',
        type: 'checkbox',
        label: 'Add styling classes classes',
        choices: [
          {
          ...
          {
            'label': 'Children elements in one row, justified (display flex, has some quirks)',
            'value': 'display-flex'
          },
          {
            'label': 'Display block',
