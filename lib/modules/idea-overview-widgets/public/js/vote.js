...
var matchReturnedFrom = getUrlParameter('returnedFromVerification'); //window.location.hash.match(/returnedFromVerification-(\d+)/);
var returnFromId = matchReturnedFrom ? matchReturnedFrom[1] : undefined;
var returnedFromVerification =  !!returnFromId;

console.log('returnedFromVerification', returnedFromVerification);
console.log('matchReturnedId', returnFromId);
