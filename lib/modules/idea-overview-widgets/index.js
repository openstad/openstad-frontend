  ...
  construct: function(self, options) {
    options.arrangeFields = (options.arrangeFields || []).concat([
      ...
      },
      {
        name: 'gridder',
        label: 'Uitklapper',
        fields: ['gridder_text_open', 'gridder_text_vote_button', 'gridder_tile_image_aspect_ratio', 'gridder_use_field_as_title' ]
      },
      {
        name: 'voting',
        label: 'Voting',
        fields: ['voting', 'vote_block_show_text_1', 'vote_block_show_text_2', ]
      },
      {
        name: 'sorting',
        label: 'Sorting',
        fields: ['defaultSorting', 'selectedSorting' ]
      },
    /*  {
        name: 'text',
        label: 'Text',
