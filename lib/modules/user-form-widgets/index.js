...
module.exports = {
    ...
    construct: function (self, options) {
        ...
        self.pushAssets     = function () {
            superPushAssets();
            self.pushAsset('stylesheet', 'main', {when: 'user'});
          //  self.pushAsset('script', 'filepond', {when: 'user'});
            self.pushAsset('script', 'init_filepond', {when: 'user'});
            self.pushAsset('script', 'main', {when: 'user'});
        };
