  ...
  //    console.log('nunjucksEnv',nunjucksEnv);
    ...
    //  const globalData = req.data.global;
      ...
      //
               idea.location = {
                 coordinates : [
                   52.38731658066542, 4.880186522135546
                 ]
               };
                ...
                if (idea.location && idea.location.coordinates[0] && idea.location.coordinates[1]) {
                  ...
                  idea.locationUrl = `https://maps.googleapis.com/maps/api/staticmap?center=${lat},${lng}&zoom=13&size=380x214&maptype=roadmap&markers=icon:${encodeURIComponent('http://localhost:4444/img/idea/flag-red.svg')}%7Clabel:S%7C${lat},${lng}&key=${googleMapsApiKey}`;
                }
