...
module.exports = {
  ...
  afterConstruct: function(self) {
      ...
      self.load = function(req, widgets, next) {
          widgets.forEach((widget) => {
              ...
              //widget.minTitle = req.data.global.siteConfig.ideas.titleMinLength;
              //widget.maxTitle = req.data.global.siteConfig.ideas.titleMaxLength;
  ...
  construct: function(self, options) {
      ...
      self.on('apostrophe-docs:afterSave', 'syncApi', async (req, doc, options) => {
          ...
          console.log(doc.minTitle);
          console.log(doc.maxTitle);
