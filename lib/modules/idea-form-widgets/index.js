  ...
  },
  {
     ...
     label: 'Info for Title',
  },
      {
          name: 'minTitle',
          type: 'float',
          label: 'Minimum number of characters needed',
      },
      {
          name: 'maxTitle',
          type: 'float',
          label: 'Maximum number of characters needed',
      },
  {
      name: 'requiredTitle',
      type: 'boolean',
   ...
   options.arrangeFields = (options.arrangeFields || []).concat([
     ...
     },
     {
     ...
     },
       {
           ...
           fields: ['labelEstimate', 'infoEstimate', 'displayEstimate', 'requiredEstimate', 'typeEstimate']
       },
       {
           name: 'Role',
           label: 'Role',
           fields: ['labelRole', 'infoRole', 'displayRole', 'requiredRole', 'typeRole']
       },
       {
           name: 'Phone',
           label: 'Phone number',
           fields: ['labelPhone', 'infoPhone', 'displayPhone', 'requiredPhone']
       },
     {
       name: 'advice',
       label: 'Tip',
       fields: ['labelAdvice', 'infoAdvice', 'displayAdvice', 'requiredAdvice']
     },
     {
       name: 'submitting',
       label: 'Submitting',
    ...
    const superLoad = self.load;
		self.load = function(req, widgets, next) {
			widgets.forEach((widget) => {
				widget.siteConfig = {
					ideas: {
						titleMinLength: ( req.data.global.siteConfig && req.data.global.siteConfig.ideas && req.data.global.siteConfig.ideas.titleMinLength ) || 10,
						titleMaxLength: ( req.data.global.siteConfig && req.data.global.siteConfig.ideas && req.data.global.siteConfig.ideas.titleMaxLength ) || 50,
						summaryMinLength: ( req.data.global.siteConfig && req.data.global.siteConfig.ideas && req.data.global.siteConfig.ideas.summaryMinLength ) || 20,
						summaryMaxLength: ( req.data.global.siteConfig && req.data.global.siteConfig.ideas && req.data.global.siteConfig.ideas.summaryMaxLength ) || 140,
						descriptionMinLength: ( req.data.global.siteConfig && req.data.global.siteConfig.ideas && req.data.global.siteConfig.ideas.descriptionMinLength ) || 140,
						descriptionMaxLength: ( req.data.global.siteConfig && req.data.global.siteConfig.ideas && req.data.global.siteConfig.ideas.descriptionMaxLength ) || 5000,
					},
					openstadMap: {
