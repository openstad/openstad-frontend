     ...
     self.pushAssets = function () {
      ...
      self.load = function (req, widgets, next) {
          ...
          widgets.forEach((widget) => {
              ...
              const ideaId = req.params['0'].replace('/plan/', '');
              ...
              widget.mapConfig = self.getMapConfigBuilder(globalData)
                  .setDefaultSettings({
                      mapCenterLat: idea.location.coordinates[0] || globalData.mapCenterLat,
                      mapCenterLng: idea.location.coordinates[1] || globalData.mapCenterLng,
                      mapZoomLevel: 16,
                      zoomControl: true,
