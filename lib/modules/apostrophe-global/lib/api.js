...
module.exports = (self, options) => {
    ...
    self.overrideGlobalDataWithSiteConfig = (req, res, next) => {
      ...
      req.data.global.mapPolygonsKey = (req.data && req.data.global && req.data.global.siteConfig && req.data.global.siteConfig.area && req.data.global.siteConfig.area.id) || '';
      ...
      console.log (req.data.global.siteConfig.area, req.data.global.mapPolygonsKey, 'POLYGONS')
