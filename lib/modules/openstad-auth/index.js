  ...
  // You can add routes here
    self.apos.app.use((req, res, next) => {
      if (req.query.jwt) {
        ...
        // scene is used by APOS te determine what assets to load, for some reason live there are some mistakes when loading this
        // this is local patch so only
        req.scene = req.user ? 'user' : 'anon';

        console.log('local req.scene', req.scene);
