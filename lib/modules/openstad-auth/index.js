...
module.exports = {
  ...
  // You can add routes here
    self.apos.app.use((req, res, next) => {
      ...
      //apostrhophe for some reasons always sets the scene to user
      //this means it always
      ...
      //add apostrophes permissions to the data object so we can check it in the templates
