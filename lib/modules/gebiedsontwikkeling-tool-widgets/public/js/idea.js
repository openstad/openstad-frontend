...
function showIdeaDetails() {
	...
	if (currentIdea.argumentsFor.length) {
...
function openStep(stepDiv, scrollTo) {
	...
	if (typeof scrollTo != 'undefined') {
		document.querySelector('#info-block .content').scrollTo(0, scrollTo)
	} else {
		document.querySelector('#info-block .content').scrollTo(0, stepDiv.offsetTop - 30)
	}
}
