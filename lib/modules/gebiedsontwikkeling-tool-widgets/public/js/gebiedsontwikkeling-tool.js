...
function showIdeasOnMap(startWithIdeaId) {
	...
	console.log(startWithIdeaId,startWithArgumentsForId );
	...
	$.ajax({
		...
		success: function(ideas) {
			...
			if (startWithMarker) {
				...
				console.log(startWithIdeaId, startWithArgumentsForId, startWithReactionsForArgumentId);
...
function onClickMap(args) {
	...
	if (currentInput.marker) {
		...
		console.log(currentInput.marker);
...
function activateFilter(which) {
	...
	document.getElementById('filter-select').value = activeFilter;
