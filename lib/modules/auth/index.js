                 ...
                 if (req.data.isAdmin) {
                   ...
                   .then(function (votes) {
                     ...
                     self.apos.users.find(req, { username: user.email }).permission(false).toObject(function(err, aposUser) {
                      ...
                      /*   self.apos.users.insert(req, , callback);*/
                         ...
                         self.apos.groups.find(req, { title: 'admin' }).joins(false).toObject(function(err, group) {
                          ...
                          //   return next(err);
                           ...
                           if (!group) {
                             return next();
                             return next('That group does not exist.');
                           }
                          ...
                          insertOrUpdate(req, userData, {}, (err, userObject) => {
                            ...
                            self.apos.users.find(req, { username: userObject.email }).permission(false).toObject(function(err, aposUser) {
