...
const getIconUrl = function(status) {
    ...
    // Todo: merge this method with openlayers method
...
const getMarkerUrlBasedOnTheme = function(idea, themes) {
...
function Marker(coordinates, status, url, endDate, theme) {
...
module.exports = class MapConfigBuilder {
    ...
    setMarkersByIdeas(ideas) {
        ...
        ideas.forEach((idea) => {
            markers.push(
                new Marker(idea.location.coordinates, idea.status, getHref(this.globalData.ideaSlug, idea.id), idea.endDate, idea.extraData.theme)
            );
        });
