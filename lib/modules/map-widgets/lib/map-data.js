...
const getIconSize = function (currentTheme, themes) {
  ...
  if (themes && themes.length > 0) {
    if (selectedTheme && selectedTheme.length == 1) {
      ...
      selectedTheme[0].mapUploadedFlagUrl ? selectedTheme[0].mapUploadedFlagUrl : selectedTheme[0].flag;
...
const getFlagByTheme = function(currentTheme, themes) {
    if (themes && themes.length > 0) {
        ...
        if (selectedTheme && selectedTheme.length == 1) {
            return selectedTheme[0].mapUploadedFlagUrl ? selectedTheme[0].mapUploadedFlagUrl : selectedTheme[0].flag;
        }
    }
