...
const googlemapsData = require('./lib/googlemaps-data');
const openlayersData = require('./lib/openlayers-data');
...
module.exports = {
    ...
    construct: function(self, options) {
        ...
        self.createOverviewData = (ideas, data) => {
            if (config.getMapType() === 'nlmaps-openlayers') {
                return openlayersData.createMapConfig(ideas, data);
            }
            return googlemapsData.createMapConfig(ideas, data, styles, null);
        }
    }
};
