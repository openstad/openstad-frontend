...
var OpenlayersMap = {
    ...
    createMap: function (settings) {
        const center = settings.center && settings.center? { latitude: settings.center.lat, longitude: settings.center.lng } : { longitude: 4.2322689, latitude:  52.04946}
        var defaultSettings = {
            style:   'standaard',
        ...
        this.map = nlmaps.createMap(defaultSettings);
