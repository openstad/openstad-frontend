...
//	var elements = document.getElementsByClassName('idea-item');
	...
	sortedElements.forEach( function(element) {
		...
		console.log('elementThema', elementThema, '===', activeThema);
		console.log('!activeThema || activeThema == 0', !activeThema || activeThema == 0);
		console.log('elementGebied', elementGebied, '===', activeGebied);
