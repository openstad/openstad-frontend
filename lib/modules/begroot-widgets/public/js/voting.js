...
function updateList() {
	...
	// tijdelijke botte bijl oplossing: deze functie wordt aangeroepen vanaf iets waar hij niet moet worden aangeroepen; negeer dat
	if (!list || !sortedElements) return;
...
function handleClick(event) {
	...
	if (document.querySelector('#budgeting-edit-mode')) {
		document.querySelector('#budgeting-edit-mode').checked = false;
		// addToClassName(document.querySelector('#budgeting-edit-mode-container'), 'hidden');
		setBudgetingEditMode()
	}
