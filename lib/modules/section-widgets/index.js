      ...
      return superLoad(req, widgets, function (err) {
        ...
        widgets.forEach((widget) => {
          //is Admin needs to be set to widget object otherwise it's not present during ajax call
            ...
            widget.contentWidgets = self.apos.permissions.can(req, 'admin') ? contentWidgets.getAdminWidgets(siteConfig.widgetDisplaySettings) : contentWidgets.getEditorWidgets(siteConfig.widgetDisplaySettings);
        });
