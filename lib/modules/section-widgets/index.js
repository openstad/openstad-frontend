    ...
    self.load = function (req, widgets, callback) {
      return superLoad(req, widgets, function (err) {
        ...
        widgets.forEach((widget) => {
          ...
          //
          widget.isAdmin = widget.isAdmin !== undefined ? widget.isAdmin : req.data.isAdmin;

          console.log('widget.isAdmin', widget.isAdmin);
          ...
          if (widget.containerStyles) {
            ...
            widget.contentWidgets = req.data.isAdmin ? contentWidgets.getAdminWidgets(siteConfig.widgetDisplaySettings) : contentWidgets.getEditorWidgets(siteConfig.widgetDisplaySettings);
          }
        });
