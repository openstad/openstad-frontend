...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    //    widget.selectedArea = req.data.query.area ? req.data.query.area : (widget.defaultArea ? widget.defaultArea : '');
        ...
        const cacheKey = req.data.global.siteId;//encodeURIComponent(getUrl);
        ...
        if (response) {
          console.log('get from cache', getUrl, cacheKey)
          ...
          promises.push(function (req, self){
            return new Promise((resolve, reject) => {
              console.log('fetch from api', getUrl, cacheKey)
              ...
              .then((response) => {
                ...
                if (globalData.cacheIdeas) {
                  console.log('set cachee', cacheKey);
