...
module.exports = {
    ...
    //    widget.selectedArea = req.data.query.area ? req.data.query.area : (widget.defaultArea ? widget.defaultArea : '');
        ...
        req.data.widgetRequestData.openstadTags =  tags ? tags.map((tag) => {
          return Object.assign(tag, {
            ...
            selectionUrl: self.formatTagSelectUrl(tag, Object.assign({}, queryObject)),
            removeUrl: self.formatTagRemoveUrl(tag,  Object.assign({}, queryObject)),
            isSelected: self.isTagSelected(tag, Object.assign({}, queryObject))
          })
        }) : [];


        console.log('req.data.widgetRequestData.openstadTags 1', req.data.widgetRequestData.openstadTags)

        promises.push(function (req, self){
          return new Promise((resolve, reject) => {
            rp(options)
            .then((response)  => {
              console.log('req.data.widgetRequestData.openstadTags 2', req.data.widgetRequestData.openstadTags)
  ...
  //            widget.activeResources = self.filterResources(response.records);
              ...
              console.log('req.data.widgetRequestData.paginationUrls', req.data.widgetRequestData.paginationUrls);
