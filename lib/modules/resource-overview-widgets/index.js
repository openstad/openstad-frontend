...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    const superLoad = self.load;
      ...
      //set no cache headers to prevent issues
    //  req.res.setHeader('Surrogate-Control', 'no-store');
    ...
    //    widget.selectedArea = req.data.query.area ? req.data.query.area : (widget.defaultArea ? widget.defaultArea : '');
        ...
        widget.openstadTags =  tags ? tags.map((tag) => {
          return Object.assign(tag, {
            ...
            selectionUrl: self.formatTagSelectUrl(tag, widget.pathname, Object.assign({}, req.query)),
            removeUrl: self.formatTagRemoveUrl(tag, widget.pathname, Object.assign({}, req.query)),
