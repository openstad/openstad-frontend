      ...
      const promises = [];
        ...
        promises.push(new Promise((resolve, reject) => {
          ...
          .then((response)  => {
            ...
            widget.resultCountText = widget.resultCountText ? widget.resultCountText.replace('{{visibleCount}}', response.records.length).replace('{{totalCount}}', response.metadata.totalCount) : '';
