...
function initRoleRequired() {
  ...
  $(".role-required-member").on('click', function (ev) {
    ...
    console.log(userRole !== 'member' && userRole !== 'admin');
    if (userRole !== 'member' && userRole !== 'admin') {
      console.log('userRole in in');
...
//      loginUrl = $(this).attr('data-return-to') ? loginUrl + '&returnTo=' + $(this).attr('data-return-to') : loginUrl;
//      window.location.href = loginUrl;
    }
  });
